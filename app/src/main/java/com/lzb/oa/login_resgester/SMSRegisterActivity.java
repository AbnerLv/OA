package com.lzb.oa.login_resgester;
...
public class SMSRegisterActivity extends BaseActivity implements
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
             ...
             * 短信注册成功后，返回MainActivity,然后提示新好友 if (event ==
             ...
             *//*
                ...
                *//*
                   ...
                   * .toString().trim()); } else if (event ==
                   * SMSSDK.EVENT_GET_VERIFICATION_CODE) {
                   * Toast.makeText(getApplicationContext(), "验证码已经发送",
                   * Toast.LENGTH_SHORT).show(); } else if (event ==
    ...
    public void onClick(View v) {
        ...
        case R.id.btn_next:// 校验验证码
            if (!TextUtils.isEmpty(etVerifycode.getText().toString())) {
                // SMSVerifyUtil.submitCode(code, phString,
                // etVerifycode.getText()
                // .toString());
                // SMSSDK.submitVerificationCode(code, phString,
                // verEditText.getText().toString());
            } else {
