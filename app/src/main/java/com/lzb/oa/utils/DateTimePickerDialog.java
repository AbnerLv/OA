...
public class DateTimePickerDialog {
    ...
    /**
     * 日期样式一 可以滚动选择年、月、日，也可以通过点击日历上的日期获得选择值
     * 
     * @param context
     *            上下文
     * @param calendar
    ...
    public static void dateDialogAll(Context context, Calendar calendar,
        ...
        DatePickerDialog.OnDateSetListener dateListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month,
                ...
                editText.setText(new SimpleDateFormat("yyyy-MM-dd")
                        .format(dateFormat));
            }
        };
    ...
    public static void dateDialogOnlyScollSelect(Context context,
            Calendar calendar, final EditText editText) {
        DatePickerDialog.OnDateSetListener dateListener = new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker datePicker, int year, int month,
                    int dayOfMonth) {
        ...
        DatePickerDialog date = new DatePickerDialog(context, dateListener,
                calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),
     ...
     *            用于存储结果的输入框
     */
    public static void dateDialogOnlyCalendar(Context context,
            Calendar calendar, final EditText editText) {
        DatePickerDialog.OnDateSetListener dateListener = new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker datePicker, int year, int month,
    ...
    public static void timeDialogScollSelect(Context context,
            Calendar calendar, final EditText editText) {
        TimePickerDialog.OnTimeSetListener timeListener = new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timerPicker, int hourOfDay,
                ...
                Date timeFor = null;
                try {
                    timeFor = new SimpleDateFormat("HH:ss").parse(time
                            .toString());
                } catch (ParseException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
        ...
        new TimePickerDialog(context, timeListener,
                ...
                calendar.get(Calendar.MINUTE), true).show(); // 是否为二十四制，如果是false则为12小时制
    }
