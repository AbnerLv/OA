...
public class ComplanyMeetingDetail extends BaseActivity {
    ...
    public static void startComplanyMeetingDetail(Context context,
            String meetingTheme, String meetingStarttime,
    ...
    private void init() {
        ...
        tvMeetingDetailStarttime.setText("开始时间："
                + intent.getStringExtra("meetingStarttime"));
        tvMeetingDetailEndtime.setText("结束时间："
                + intent.getStringExtra("meetingEndtime"));
        tvMeetingDetailAddress.setText("开会地址："
                + intent.getStringExtra("meetingAddress"));
