...
public class ComplanyNoticesDetial extends BaseActivity implements
        OnClickListener {
    ...
    public static void startComplanyNoticesDetial(Context context,
            String noticeTheme, String noticeDate, String noticeContent,
            String noticeEmpNo) {
    ...
    public void onClick(View v) {
        ...
        case R.id.layout_notices_detail_emp:
            Toast.makeText(ComplanyNoticesDetial.this,
                    tvNoticesDetailEmp.getText(), Toast.LENGTH_SHORT).show();
            break;
