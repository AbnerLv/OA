...
public class PullToRefreshHorizontalScrollView
    ...
    @Override protected HorizontalScrollView createRefreshableView(
    ...
    @Override protected boolean isReadyForPullEnd() {
        ...
        if (null != scrollViewChild) {
            return mRefreshableView.getScrollX() >= (scrollViewChild.getWidth()
                    - getWidth());
        }
        return false;
    }

    @TargetApi(9) final class InternalHorizontalScrollViewSDK9
        ...
        @Override protected boolean overScrollBy(int deltaX, int deltaY,
            ...
            OverscrollHelper
                    .overScrollBy(PullToRefreshHorizontalScrollView.this,
        ...
        private int getScrollRange() {
            ...
            if (getChildCount() > 0) {
                ...
                scrollRange = Math.max(0,
                        child.getWidth() - (getWidth() - getPaddingLeft()
                                - getPaddingRight()));
            }
            return scrollRange;
        }
