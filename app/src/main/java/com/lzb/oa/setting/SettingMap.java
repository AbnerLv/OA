...
public class SettingMap extends BaseActivity implements
     ...
     *            详细地址
     */
    public static void startSettingMapSearch(Context context, String city,
            String address) {
        Intent intent = new Intent(context, SettingMap.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBaiduMap.setMapStatus(MapStatusUpdateFactory
                .newMapStatus(new MapStatus.Builder().target(point).zoom(15)
                        .build()));
        // 构建Marker图标
        ...
        // Toast.makeText(this, city + "::" + address,
        ...
        /*
         * //flag为false时--定位；flag为true是--标注 if (flag) { mSearch.geocode(new
         * GeoCodeOption() .city("上海") .address("浦东新区浦建路725弄2号")); } else {
         * 
         * //定位初始化 mLocClient = new LocationClient(this); //开启定位图层
         * mBaiduMap.setMyLocationEnabled(true); //定位初始化 mLocClient = new
         * LocationClient(this); // 初始化搜索模块，注册事件监听 mSearch =
         * GeoCoder.newInstance(); mSearch.setOnGetGeoCodeResultListener(this);
         * mLocClient.registerLocationListener(myListener); LocationClientOption
         ...
         * 
         * //构建MarkerOption，用于在地图上添加Marker OverlayOptions options = new
         * MarkerOptions() .position(point) //设置marker的位置 .icon(bitmap)
         * //设置marker图标 .zIndex(15) //设置marker所在层级 .draggable(true); //设置手势拖拽
         * //将marker添加到地图上 marker = (Marker) (mBaiduMap.addOverlay(options));
         * //在地图上添加Marker，并显示 mBaiduMap.addOverlay(options); }
         */
    ...
    private void popupInfo(RelativeLayout layout, ReverseGeoCodeResult result) {
        // TODO Auto-generated method stub

        ViewHolder viewHolder = null;
        if (layout.getTag() == null) {
            viewHolder = new ViewHolder();
            viewHolder.tvName = (TextView) layout.findViewById(R.id.tv_name);
            viewHolder.tvAddress = (TextView) layout
                    .findViewById(R.id.tv_address);
            viewHolder.btnOk = (Button) layout.findViewById(R.id.btn_ok);
            viewHolder.btnCancel = (Button) layout
        ...
        viewHolder.btnCancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Toast.makeText(SettingMap.this, "CANCEL", Toast.LENGTH_LONG)
                        .show();
            }
        });
    }
    ...
    private class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (isFirstLoc) {
                ...
                /*
                 * // 反Geo搜索 mSearch.reverseGeoCode(new ReverseGeoCodeOption()
                 * .location(ll));
                 */
                /*
