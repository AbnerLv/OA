...
public class PullToRefreshListView
    ...
    @Override protected void onReset() {
        ...
        case PULL_FROM_END:
            ...
            scrollLvToEdge = Math.abs(
                    mRefreshableView.getLastVisiblePosition() - selection) <= 1;
            break;
        case PULL_FROM_START:
        default:
            ...
            selection = 0;
            scrollLvToEdge = Math.abs(
                    mRefreshableView.getFirstVisiblePosition() - selection)
                    <= 1;
            break;
        }
    ...
    @Override protected LoadingLayoutProxy createLoadingLayoutProxy(
            final boolean includeStart, final boolean includeEnd) {
        LoadingLayoutProxy proxy = super
                .createLoadingLayoutProxy(includeStart, includeEnd);
    ...
    @Override protected ListView createRefreshableView(Context context,
            AttributeSet attrs) {
    ...
    @Override protected void handleStyledAttributes(TypedArray a) {
        ...
        mListViewExtrasEnabled = a
                .getBoolean(R.styleable.PullToRefresh_ptrListViewExtrasEnabled,
                        true);
    ...
    @TargetApi(9) final class InternalListViewSDK9 extends InternalListView {
        ...
        @Override protected boolean overScrollBy(int deltaX, int deltaY,
            ...
            final boolean returnValue = super
            ...
            OverscrollHelper
                    .overScrollBy(PullToRefreshListView.this, deltaX, scrollX,
