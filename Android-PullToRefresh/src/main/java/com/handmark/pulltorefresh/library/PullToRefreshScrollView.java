...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
    ...
    @Override protected ScrollView createRefreshableView(Context context,
            AttributeSet attrs) {
    ...
    @Override protected boolean isReadyForPullEnd() {
        ...
        if (null != scrollViewChild) {
            return mRefreshableView.getScrollY() >= (scrollViewChild.getHeight()
                    - getHeight());
        }
        return false;
    }

    @TargetApi(9) final class InternalScrollViewSDK9 extends ScrollView {
        ...
        @Override protected boolean overScrollBy(int deltaX, int deltaY,
            ...
            OverscrollHelper
                    .overScrollBy(PullToRefreshScrollView.this, deltaX, scrollX,
