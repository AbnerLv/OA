...
@SuppressLint("ViewConstructor") public class FlipLoadingLayout
    ...
    @Override protected void onLoadingDrawableSet(Drawable imageDrawable) {
    ...
    @Override protected void onPullImpl(float scaleOfLayout) {
        // NO-OP
    }
    ...
    @Override protected void releaseToRefreshImpl() {
    ...
    @Override protected int getDefaultDrawableResId() {
