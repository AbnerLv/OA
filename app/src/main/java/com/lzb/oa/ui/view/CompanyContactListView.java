...
import com.lzb.oa.ui.adapter.HeaderAdapter;

public class CompanyContactListView extends ExpandableListView implements OnScrollListener,OnGroupClickListener {

	private static final String TAG = "CompanyContactListView";
	public CompanyContactListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public CompanyContactListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public CompanyContactListView(Context context) {
		super(context);
		registerListener();
	}
