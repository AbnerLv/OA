...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
    ...
    public final void onScroll(final AbsListView view,
        ...
        if (DEBUG) {
            Log.d(LOG_TAG,
                    "First Visible: " + firstVisibleItem + ". Visible Count: "
                            + visibleItemCount + ". Total Items:"
                            + totalItemCount);
        }
    ...
    public final void setEmptyView(View newEmptyView) {
        ...
        if (null != newEmptyView) {
            ...
            // FrameLayout
            FrameLayout.LayoutParams lp = convertEmptyViewLayoutParams(
    ...
    @Override protected void handleStyledAttributes(TypedArray a) {
        ...
        mShowIndicator = a
                .getBoolean(R.styleable.PullToRefresh_ptrShowIndicator,
    ...
    private void addIndicatorViews() {
        ...
        if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
            ...
            params.rightMargin = getResources()
                    .getDimensionPixelSize(R.dimen.indicator_right_padding);
    ...
    private boolean isLastItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            ...
            if (lastVisiblePosition >= lastItemPosition - 1) {
                final int childIndex = lastVisiblePosition - mRefreshableView
