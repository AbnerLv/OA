...
public class PullToRefreshExpandableListView
    ...
    @Override protected ExpandableListView createRefreshableView(
    ...
    @TargetApi(9) final class InternalExpandableListViewSDK9
            extends InternalExpandableListView {
        ...
        @Override protected boolean overScrollBy(int deltaX, int deltaY,
            ...
            OverscrollHelper
                    .overScrollBy(PullToRefreshExpandableListView.this, deltaX,
